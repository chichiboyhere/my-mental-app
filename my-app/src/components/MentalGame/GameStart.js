    ...
    <Card className={classes.container}>
      ...
      <div className="container">
          <Card className={classes.input}>
              <label htmlFor='enter_multiplication_table_limit'>Enter Multiplication Table Limit</label>
              <input id='enter_multiplication_table_limit' type='text' value={enteredTable}  onKeyPress={inputKeyPress} onChange={tableChangeHandler} />     
          </Card>
      </div>
      <div className="new-game">
                ...
                {isGameStart && (
                  <MentalGame table={tableIn} onSend={resultPusher} onCancel={stopGameHandler} reTake={reTakehandler} />
                )}
              </div>
